...
describe('DataModel', () => {
    ...
    context('Test for empty DataModel', () => {
        const data = [];
        const schema = [];
        const edm = new DataModel(data, schema);
    ...
    describe('#caclulatedVariable', () => {
        ...
        it('should return correct value from the callback funciton', () => {
            ...
            const callback2 = function (a, aaa, ...arg) {
                return a + aaa + arg[0];
            };
    ...
    describe('#bin', () => {
        it('should bin the data when buckets are given', () => {
            ...
            const fieldData = bin.getFieldspace().fields.find(field => field.name === 'sumField').data;
            const expectedData = ['5-11', '11-16', '11-16', '11-16', '5-11', '16-20', '20-30', '16-20', '20-30'];
        ...
        it('should bin the data when buckets are given but data value having lesser and greater value', () => {
            ...
            const bin = dataModel.bin('profit', { buckets, name: 'sumField' });
            const fieldData = bin.getFieldspace().fields.find(field => field.name === 'sumField').data;
            const expectedData = ['10-11', '5-10', '5-10', '11-16', '10-11', '16-20', '20-30', '16-20', '30-32'];
            expect(fieldData).to.deep.equal(expectedData);
        ...
        it('should bin data when num of bins given', () => {
            ...
            const fieldData = bin.getFieldspace().fields.find(field => field.name === 'sumField').data;
            const expData = ['10-16', '10-16', '10-16', '10-16', '10-16', '16-22', '16-22', '16-22', '16-22', '16-22'];
        ...
        it('should bin data when binSize is given', () => {
            ...
            const fieldData = bin.getFieldspace().fields.find(field => field.name === 'sumField').data;
            const expData = ['10-15', '15-20', '15-20', '15-20', '10-15', '15-20', '20-25', '15-20', '20-25', '20-25'];
    ...
    context('Checking api for updating parent child relationship', () => {
        ...
        describe('#addParent', () => {
            it('Adding parent should save criteria in parent', () => {
                const dm2 = dataModel.select(fields => fields.profit.value < 150);
                const dm3 = dm2.groupBy(['sales'], {
                    profit: null
                });
                const dm4 = dm3.project(['sales']);
                const data = dm4.getData();
                const projFields = ['first'];
                const projectConfig = {};
                const normalizedprojFields = [];
                const criteriaQueue = [
                    {
                        op: 'select',
                        meta: '',
